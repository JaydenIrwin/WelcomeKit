...
public struct WelcomeView: View {
    ...
    public init(isShown: Binding<Bool>, isFirstLaunch: Bool, appName: String, appDescription: String?, feature1: WelcomeFeature, feature2: WelcomeFeature, feature3: WelcomeFeature, action: (() -> Void)?) {
        ...
        self._appDescription = State(initialValue: appDescription)
...
struct WelcomeView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return WelcomeView(isShown: .constant(true), isFirstLaunch: false, appName: "My App", appDescription: nil, feature1: f1, feature2: f2, feature3: f3, action: nil)
    }
}
